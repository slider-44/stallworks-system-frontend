        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {DENOMINATIONS.map((d, i) => (
              <tr key={d} className={`${i % 2 === 0 ? "bg-white" : "bg-slate-50"} hover:bg-teal-50/60 transition-colors`}>
                ...
                <td className="py-3 px-4">
                  <input
                    ...
                    placeholder="0"
                    className="no-spinner w-24 mx-auto block text-center font-bold text-teal-800 bg-teal-50 border-2 border-teal-200 rounded-lg px-2 py-2 text-base focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 hover:border-teal-300 transition-colors"
                  />
                </td>
