...
const SalesTabContent = forwardRef(function SalesTabContent(
  { date, branchId, employeeId, onGcashChange, onLiveTotalChange },
  ref
) {
  ...
  return (
    <div>
                ...
                >
                    ...
                    {size.manualPrice ? (
                      <div className="flex items-center gap-1.5">
                        ...
                        <input
                          ...
                          className="no-spinner w-24 border border-slate-200 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-teal-200 hover:border-teal-300 transition-colors"
                        />
                      </div>
                    ) : (
                  ...
                  <td className="py-3 px-3">
                    <input
                      ...
                      placeholder="0"
                      onWheel={(e) => e.target.blur()}
                      className="no-spinner w-24 text-center font-bold text-teal-800 bg-teal-50 border-2 border-teal-200 rounded-lg px-2 py-2 text-base focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 hover:border-teal-300 transition-colors"
                    />
                  </td>
      ...
      <div className="mt-4 bg-teal-700 rounded-xl p-4 flex items-center gap-3 shadow-sm">
        <div className="w-11 h-11 rounded-full bg-white/15 flex items-center justify-center shrink-0">
          <CircleDollarSign size={20} className="text-white" />
        </div>
        <div className="flex-1">
          <p className="text-xs font-bold uppercase tracking-wide text-teal-100">Total</p>
          <p className="text-sm font-semibold text-white -mt-0.5">Total Sales</p>
        </div>
        <span className="text-2xl font-extrabold text-white tabular-nums">₱{grandTotal.toFixed(2)}</span>
      </div>
